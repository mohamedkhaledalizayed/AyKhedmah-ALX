...
import com.mohamed.aykhedmah.databinding.ServiceItemBinding
...
class ServicesAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ITEM_TYPE_BANNER_AD -> {
                ...
                val binding: ServiceItemBinding = DataBindingUtil.inflate(layoutInflater!!, R.layout.service_item, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            ...
            ITEM_TYPE_GENERAL -> if (mList[position] is ServicesData) {
                val mHolder = holder as MyViewHolder
                val data: ServicesData = mList[position] as ServicesData

                mHolder.binding.serviceName.text = data.title
                mHolder.binding.numberProviders.text = "يوجد لدينا ${data.service_provider_count} مزود خدمة فى ${data.title} يمكنهم خدمتك على اعلى جودة"
    ...
    override fun getItemViewType(position: Int): Int {
        return if (mList[position] is ServicesData) {
            ITEM_TYPE_GENERAL
        } else {
            ITEM_TYPE_BANNER_AD
        }
    ...
    class MyViewHolder(val binding: ServiceItemBinding) : RecyclerView.ViewHolder(binding.root)
